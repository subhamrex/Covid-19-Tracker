      ...
      <div className="app__left">
          <div className ="app__header">
                ...
                <div className="app__stats">
                  ...
                  <InfoBox active={casesType ==="recovered"} onClick={e=>setCasesType('recovered')}title="Recovered" cases={prettyPrintStat(countryInfo.todayRecovered)} total={numeral(countryInfo.recovered).format("0.0a")}/>
